...
const Admin = () => {
  ...
  return (
    <div className="container mx-auto py-12 px-6">
      ...
      {/* ✅ Accueil si aucun onglet choisi (MODIFIÉ) */}
      {activeTab === null && (
        <div className="flex justify-center items-start pt-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-4xl w-full"> {/* Utilisation d'un grid pour le positionnement */}
            ...
            <div
              ...
              className="cursor-pointer bg-gray shadow-xl rounded-2xl p-10 text-center border-t-4 border-gray-600 hover:shadow-2xl transition max-w-full"
            >
      ...
      {activeTab === "formations" && (
        <>
          ...
          <button
            ...
            className="mb-6 bg-gray-600 text-white flex items-center py-2 px-4 rounded-md hover:bg-gray-700 transition"
          >
      ...
      {activeTab === "personnels" && (
        <>
          ...
          <div className="p-6 bg-white rounded-lg shadow-lg">
            <h2 className="text-2xl font-bold mb-4">Gestion des Personnels</h2>
            <p>➡ Tu ajouteras ici la gestion du personnel.</p>
          </div>
        </>
      )}
