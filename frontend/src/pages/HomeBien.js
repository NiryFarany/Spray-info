  ...
  return (
    <>
      ...
      <section className="relative min-h-screen bg-gradient-to-br from-blue-950 via-blue-800 to-blue-900 text-white flex items-center justify-center px-6 overflow-hidden">
        ...
        {/* OPACITÉ AUGMENTÉE (opacity-10 -> opacity-15) pour plus de clarté */}
        ...
        {/* Overlay sombre - OPACITÉ RÉDUITE (bg-black/40 -> bg-black/30) pour laisser passer le logo de fond */}
        ...
        <div className="relative text-center max-w-4xl mx-auto space-y-7 md:space-y-8 z-10 py-16"> 
          ...
          {/* Titre - TAILLE ENCORE RÉDUITE (lg:text-6xl -> lg:text-5xl) */}
        ...
        {/* Vague finale - NOUVELLE FORME plus douce */}
        <div className="absolute bottom-0 left-0 right-0">
          <svg viewBox="0 0 1440 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full">
            {/* Vague plus douce avec une couleur bleu très très clair */}
