// src/components/Navbar.js → VERSION ULTIME (ADMIN + CLIENT DASHBOARD DANS LE MENU)
...
import { 
  ...
  FaListAlt, 
  FaUserCog,
  FaTachometerAlt,    // Pour dashboard admin
  FaHome              // Pour dashboard client
} from 'react-icons/fa';
...
<div className="relative" ref={dropdownRef}>
  {user ? (
    ...
    /* NOUVEAU : Deux boutons quand pas connecté */
    <div className="flex items-center space-x-4">
      {/* Bouton Se connecter */}
      <Link
        to="/login"
        className="border-2 border-cyan-400 hover:bg-cyan-400 hover:text-blue-900 px-6 py-3 rounded-full font-bold text-lg transition shadow-lg"
      >
        Se connecter
      </Link>
      {/* Bouton S’inscrire (le beau bouton cyan que tu adores) */}
      <Link
        to="/register"
...
//misy register sy connecter fe halako